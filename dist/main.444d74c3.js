...
var xObject = JSON.parse(x); //把字符串转换为对象
var hashMap = xObject || [{ logo: 'B', url: 'https://www.bilibili.com' }, { logo: 'N', url: 'https://www.nowcoder.com' }];
...
var simplifyUrl = function simplifyUrl(url) {
    var b = url.replace('https://', '').replace('http://', '').replace('www.', '').replace(/\/.*/, ''); // 删除 / 开头的内容
    console.log(b);
    return b;
};
render();
...
window.onbeforeunload = function () {
    var string = JSON.stringify(hashMap); //将对象转换为字符串
...
//# sourceMappingURL=/main.444d74c3.map